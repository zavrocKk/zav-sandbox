...
| 📡 [observability-triage](observability-triage/SKILL.md) | Extraire une évidence re-exécutable (requête + fenêtre UTC + extrait) depuis Splunk / Datadog / AWS CloudWatch / Kubernetes-EKS (annexes `reference/`) | Phase Diagnostic d'un incident ou Analyse d'un bilan — transformer « ça a l'air cassé » en preuve citable | Zav | 2026-07-07 |
...
| 📚 [confluence-doc](confluence-doc/SKILL.md) | Page Confluence structurée par intention (how-to, troubleshooting, runbook, référence) + en-tête de fraîcheur | Rédiger ou restructurer de la documentation destinée à Confluence | Zav | 2026-07-07 |
