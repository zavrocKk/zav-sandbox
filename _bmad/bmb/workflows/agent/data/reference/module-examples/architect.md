...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="WS or fuzzy match on workflow-status" exec="{project-root}/_bmad/core/workflows/party-mode/workflow.md">[WS] Get workflow status or initialize a workflow if not already done (optional)</item>
