...
1. Crée `.github/agents/<nom>.agent.md` (frontmatter `name`/`description`/`tools` + corps de persona ; source unique) et son pointeur inverse `agents/personas/<nom>.md`, avec les sections : `Identité`, `Ton`,
