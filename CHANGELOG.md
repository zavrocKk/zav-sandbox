...
- **agents**: add mandatory PR line to proxy signing format
...
- **agent-signatures**: Système de signature d'agent (## Signature) dans 5 agents + `bash gsane.sh session --report` + post-session-analysis hook (DC-AGENT-SIGNATURE-001, audit-validated)
