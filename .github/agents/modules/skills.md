...
| 📡 observability-triage | [`agents/skills/observability-triage/SKILL.md`](../../../agents/skills/observability-triage/SKILL.md) | Extraire une évidence re-exécutable depuis Splunk / Datadog / AWS CloudWatch / Kubernetes-EKS — phase Diagnostic (incident) ou Analyse (bilan) |
