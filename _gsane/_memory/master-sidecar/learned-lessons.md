...
- LESSON-002 : Léger en tokens ≠ incomplet en structure. Les 8 sections sont obligatoires pour TOUS les agents. Le DC doit toujours spécifier les sections requises explicitement — Bond n'infère pas.
