...
main_config: '{project-root}/_gsane/bmad/config.yaml'
...
quick_dev_workflow: '{project-root}/_gsane/bmad/workflows/gsane-quick-flow/quick-dev/workflow.md'
...
Read fully and follow: `{project-root}/_gsane/bmad/workflows/gsane-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
