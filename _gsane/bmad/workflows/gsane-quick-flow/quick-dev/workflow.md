...
Load config from `{project-root}/_gsane/bmad/config.yaml` and resolve:
...
- `installed_path` = `{project-root}/_gsane/bmad/workflows/gsane-quick-flow/quick-dev`
- `project_context` = `**/project-context.md` (load if exists)

### Related Workflows

- `quick_spec_workflow` = `{project-root}/_gsane/bmad/workflows/gsane-quick-flow/quick-spec/workflow.md`
...
Read fully and follow: `{project-root}/_gsane/bmad/workflows/gsane-quick-flow/quick-dev/steps/step-01-mode-detection.md` to begin the workflow.
