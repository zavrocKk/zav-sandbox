...
# File References
nextStepFile: '_gsane/bmad/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `_gsane/bmad/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
