...
- gsane PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure gsane PRD principles compliance:
...
- Restructuring: Reformat content to gsane standard
...
**For restructuring:**
- Reorganize PRD to gsane standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match gsane format

**Follow gsane PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
gsane standard structure applied.
