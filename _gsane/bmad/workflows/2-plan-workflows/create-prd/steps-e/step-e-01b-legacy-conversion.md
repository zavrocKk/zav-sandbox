...
Analyze legacy PRD against gsane standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring gsane standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against gsane standard
...
**For each gsane PRD section, analyze:**
...
- Manually check PRD for each gsane section
...
**[R] Restructure to gsane** - Full conversion to gsane format, then apply your edits
...
- All 6 gsane core sections analyzed for gaps
