...
prdPurpose: '{project-root}/_gsane/bmad/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
- 🎯 Detect PRD format (gsane/legacy)
...
This file defines what makes a great gsane PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to gsane format (if legacy PRD)
...
**Check for gsane PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **gsane Standard:** 5-6 core sections present
- **gsane Variant:** 3-4 core sections present, generally follows gsane patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow gsane structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is gsane Standard/Variant:**
...
**[C] Convert to gsane Format** - Convert PRD to gsane standard structure, then apply your edits
...
- gsane PRDs proceed directly to review step
