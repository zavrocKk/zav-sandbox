...
Detect if PRD follows gsane format and route appropriately - classify as gsane Standard / gsane Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for gsane PRD Core Sections

Check if the PRD contains the following gsane PRD core sections:
...
- Follows gsane PRD structure closely

**gsane Variant:**
- 3-4 core sections present
- Generally follows gsane patterns but may have structural differences
- Missing some sections but recognizable as gsane-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow gsane PRD structure
...
**Format Classification:** [gsane Standard / gsane Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is gsane Standard or gsane Variant:**
...
This PRD does not follow gsane standard structure (only {count}/6 core sections present).
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach gsane PRD parity
...
- gsane core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- gsane Standard/Variant PRDs proceed directly to next validation step
