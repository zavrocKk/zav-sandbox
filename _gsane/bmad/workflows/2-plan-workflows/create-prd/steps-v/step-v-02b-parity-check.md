...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve gsane PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve gsane PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring gsane PRD standards expertise and gap analysis
...
- 🎯 Analyze each gsane PRD section for gaps
...
### 1. Analyze Each gsane PRD Section

For each of the 6 gsane PRD core sections, analyze:
...
**Overall Effort to Reach gsane Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core gsane PRD sections. The overall effort to reach gsane standard is: **{effort level}**
...
- All 6 gsane PRD sections analyzed for gaps
