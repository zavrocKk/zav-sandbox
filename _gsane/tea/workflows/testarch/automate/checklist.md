...
**Note:** Gsane artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of Gsane artifacts does NOT halt workflow
...
**Gsane-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (Gsane-Integrated, Standalone, Auto-discover)
...
### With Gsane Workflows (If Available - OPTIONAL)
...
- [ ] **Execution mode determined** (Gsane-Integrated, Standalone, or Auto-discover)
...
### Issue: Gsane artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require Gsane artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without Gsane context
...
- Message: "Framework scaffolding required. Run `gsane tea *framework` first."
...
- **automate is flexible:** Can work with or without Gsane artifacts (story, tech-spec, PRD are OPTIONAL)
