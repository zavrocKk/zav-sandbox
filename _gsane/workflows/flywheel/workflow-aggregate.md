...
**Your Role:** Gsane Master performs the aggregation analysis (mpliance lens) to produce an objective aggregate report. Silent execution — output is `flywheel-report.md` only.
...
### Step 2 — Extract Patterns (Master lens)
...
### Step 3 — Compliance Aggregate (Quinn lens)
