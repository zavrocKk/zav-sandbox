...
- [ ] Fournir l'**exemple de commande réel** pour interagir avec l'outil (ash gsane.sh validate).
- [ ] Ajouter le **Schéma d'Architecture** (Strike Team O(1)) et ses rôles clés.
- [ ] Corriger la coquille dans la l'arborescence (remplacer sts/ par 	ests/).
...
- [ ] Fixer la **Convention de Nommage Git** (Branches eat/, ix/ et Conventional Commits).
- [ ] Détailler le **Workflow de Pull Request** (Description CI obligatoire, jamais de push direct sur main).
- [ ] Clarifier les **Règles de Qualité (Style/Linting)** : tests obligatoires dans 	ests/ et ligne obligatoire dans CHANGELOG.md.
