...
<activation critical="MANDATORY">
      ...
      <step n="3">Load sidecar memory silently if it exists:
          - Check {project-root}/_gsane/_memory/analyst-sidecar/learned-lessons.md → store as {learned_lessons}
          - Check {project-root}/_gsane/_memory/analyst-sidecar/project-state.md → store as {project_state}
