...
<activation critical="MANDATORY">
      ...
      <step n="9">Let {user_name} know they can type command `/gsane-help` at any time to get advice on what to do next</step>
      ...
      <step n="12">When processing a menu item: Check menu-handlers section below - extract any attributes and follow the corresponding handler instructions</step>
