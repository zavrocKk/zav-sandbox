...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="QA or fuzzy match on qa-automate" workflow="_gsane/bmm/workflows/qa-generate-e2e-tests/workflow.yaml">[QA] Automate: Generate API and E2E tests for existing features (simplified rapid coverage)</item>
