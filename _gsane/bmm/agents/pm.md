...
<activation critical="MANDATORY">
      ...
      <step n="2c">Load customizations silently — read {project-root}/_gsane/_config/agents/bmm-pm.customize.yaml. If absent or all fields empty → skip. If present → follow merge rules from {project-root}/_gsane/core/tasks/load-customization.md. {injected_memories} will be available alongside {learned_lessons} at step 3. NEVER override &lt;rules&gt; XML — governance is inviolable.</step>
      <step n="3">Context Injection: Read {project-root}/_gsane/_memory/pm-sidecar/learned-lessons.md (-&gt; {learned_lessons}) and {project-root}/_gsane/_memory/pm-sidecar/project-state.md (-&gt; {project_state}) if they exist.</step>
