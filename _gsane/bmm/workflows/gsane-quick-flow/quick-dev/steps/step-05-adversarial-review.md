...
With findings in hand, read fully and follow: `{project-root}/_gsane/bmm/workflows/gsane-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
