...
- Load `{project-root}/_gsane/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_gsane/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.
