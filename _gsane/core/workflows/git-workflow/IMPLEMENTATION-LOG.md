...
### Core Workflow
- `_gsane/core/workflows/git-workflow/workflow.md` — Main workflow definition
- `_gsane/core/workflows/git-workflow/AGENT-GUIDE.md` — Agent integration guide
...
|----------|--------|--------|--------|
| git-workflow | ✅ Active | core | `/gsane-git-workflow` |
