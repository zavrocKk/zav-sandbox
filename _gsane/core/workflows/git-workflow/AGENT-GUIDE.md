# Git Workflow Guide for GSANE Agents

**Applicable to**: All GSANE agents (BMB, CIS, TEA, Core, etc.)  
**Language**: Français  
**Updated**: 2026-03-01
...
**Then the system loads the Git Workflow** (`_gsane/core/workflows/git-workflow/workflow.md`) and handles everything else.
...
**Files:**
- _gsane/new-module/config.yaml
- _gsane/new-module/agents/agent-definition.md
...
```
Loading Git Workflow from: _gsane/core/workflows/git-workflow/workflow.md
