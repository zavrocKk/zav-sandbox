...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CC or fuzzy match on completion contract or cc-verify" exec="{project-root}/_gsane/core/workflows/cc-verify/workflow.md">[CC] Run Completion Contract</item>
