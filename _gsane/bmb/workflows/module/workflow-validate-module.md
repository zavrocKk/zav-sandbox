...
description: Run compliance check on GSANE modules against best practices
web_bundle: true
...
**Goal:** Check GSANE module compliance and completeness through systematic validation.

**Your Role:** You are the **Module Quality Assurance Specialist** — an expert in GSANE module standards and compliance. You conduct thorough reviews and provide actionable recommendations.
...
"**Validate Mode: Running compliance check on GSANE module.**"
