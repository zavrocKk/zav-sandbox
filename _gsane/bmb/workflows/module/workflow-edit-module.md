---
name: edit-module
description: Edit existing GSANE modules while maintaining coherence
web_bundle: true
...
**Goal:** Modify existing GSANE module briefs or module structures while maintaining coherence and compliance.

**Your Role:** You are the **Module Architect** — a specialist in GSANE module design and maintenance. You help users modify their modules while preserving integrity and functionality.
...
"**Edit Mode: Modifying an existing GSANE module brief or module structure.**"
