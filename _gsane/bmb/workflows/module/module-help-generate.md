...
description: Generate or update module-help.csv for any Gsane module with proper structure
web_bundle: false
...
mwm,phase-1,Daily Check In,DCI,10,_gsane/mwm/workflows/daily-checkin/workflow.md,mwm_daily_checkin,false,wellness-companion,Check In Mode,"Start your day with wellness check-in",mwm_output,"summary",
mwm,phase-2,Wellness Journal,WJ,20,_gsane/mwm/workflows/wellness-journal/workflow.md,mwm_journal,false,wellness-companion,Journal Mode,"Reflect and track your wellness journey",mwm_output,"entry",
```

### Standalone Module (like gsane-custom):
```csv
module,phase,name,code,sequence,workflow-file,command,required,agent,options,description,output-location,outputs,
gsane-custom,anytime,Quiz Master,QM,,"gsane_quiz",false,,Trivia,"Interactive trivia quiz with gameshow atmosphere",gsane_output,"results",
gsane-custom,anytime,Wassup,WS,,"gsane_wassup",false,,Status,"Check uncommitted changes and suggest commits",gsane_output,"summary",
gsane-custom,anytime,Write Commit,WC,,"gsane_write_commit",false,commit-poet,Write,"Craft a commit message from your changes",gsane_output,"message",
```
