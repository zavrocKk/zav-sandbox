...
`module.yaml` is the configuration file for a GSANE module. It:
...
```yaml
code: bmgd
name: "BMGD: Gsane Game Development"
header: "Gsane Game Development Module"
...
1. Run `gsane install` in a test project
