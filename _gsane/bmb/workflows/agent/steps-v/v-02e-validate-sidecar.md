...
Validate the agent's sidecar structure (if hasSidecar: true) against GSANE standards as defined in agentValidation.md. Append findings to validation report and auto-advance.
...
- [ ] Verify path format is correct: `{project-root}/_gsane/_memory/{sidecar-folder}/...`
...
- [ ] Loads sidecar memories: `{project-root}/_gsane/_memory/{sidecar-folder}/memories.md`
- [ ] Loads sidecar instructions: `{project-root}/_gsane/_memory/{sidecar-folder}/instructions.md`
- [ ] Restricts file access: `ONLY read/write files in {project-root}/_gsane/_memory/{sidecar-folder}/`
...
- [ ] Sidecar path format correct: `{project-root}/_gsane/_memory/{sidecar-folder}/...`
