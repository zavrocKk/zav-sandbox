...
agent:
  metadata:
    id: _gsane/agents/{agent-name}/{agent-name}.md
    name: 'Persona Name'
    title: 'Agent Title'
    icon: '<emoji>'
...
|-------|--------|---------|
| `id` | `_gsane/agents/{name}/{name}.md` | `_gsane/agents/commit-poet/commit-poet.md` |
...
**Installation path:** `{project-root}/_gsane/_memory/{sidecar-folder}/`

**ALL references MUST use:**
```yaml
{project-root}/_gsane/_memory/{sidecar-folder}/{file}
```
...
# ✅ CORRECT
critical_actions:
  - "Load COMPLETE file {project-root}/_gsane/_memory/journal-keeper-sidecar/memories.md"
  - "ONLY read/write files in {project-root}/_gsane/_memory/journal-keeper-sidecar/"
...
```yaml
critical_actions:
  - 'Load COMPLETE file {project-root}/_gsane/_memory/{sidecar-folder}/memories.md'
  - 'Load COMPLETE file {project-root}/_gsane/_memory/{sidecar-folder}/instructions.md'
  - 'ONLY read/write files in {project-root}/_gsane/_memory/{sidecar-folder}/'
```
...
menu:
  ...
  - trigger: SM or fuzzy match on save
    action: "Update {project-root}/_gsane/_memory/{sidecar-folder}/memories.md"
...
- 'Load from {project-root}/_gsane/_memory/{sidecar-folder}/knowledge/ but NEVER modify'
- 'Write ONLY to {project-root}/_gsane/_memory/{sidecar-folder}/memories.md'
...
### hasSidecar: true
- [ ] ALL paths: `{project-root}/_gsane/_memory/{sidecar-folder}/...`
