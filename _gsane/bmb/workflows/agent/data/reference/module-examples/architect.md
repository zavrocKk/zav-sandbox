...
<activation critical="MANDATORY">
      ...
      <menu-handlers>
        ...
        2. Read the complete file - this is the CORE OS for executing GSANE workflows
  ...
  <menu>
    ...
    <item cmd="WS or fuzzy match on workflow-status" exec="{project-root}/_gsane/core/workflows/party-mode/workflow.md">[WS] Get workflow status or initialize a workflow if not already done (optional)</item>
    <item cmd="CA or fuzzy match on create-architecture" exec="todo">[CA] Create an Architecture Document</item>
    <item cmd="IR or fuzzy match on implementation-readiness" exec="todo">[IR] Implementation Readiness Review</item>
