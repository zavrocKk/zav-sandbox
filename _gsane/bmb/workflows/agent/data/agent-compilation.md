...
agent:
  ...
  critical_actions:              # Optional - ANY agent can have these
    - "Load COMPLETE file {project-root}/_gsane/_memory/journal-sidecar/memories.md"
    - "Load COMPLETE file {project-root}/_gsane/_memory/journal-sidecar/instructions.md"
    - "ONLY read/write files in {project-root}/_gsane/_memory/journal-sidecar/"
...
<menu>
  ...
  <item cmd="DA or fuzzy match on exit leave goodbye dismiss agent" exec="{project-root}/_gsane/core/workflows/post-session-analysis/workflow.md">[DA] Dismiss Agent</item>
</menu>
</agent>
```
