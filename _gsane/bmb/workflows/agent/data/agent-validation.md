...
- [ ] No `{project-root}/_gsane/_memory/` paths
...
- [ ] ALL sidecar paths: `{project-root}/_gsane/_memory/{sidecar-folder}/...`
...
| `./sidecar/memories.md` | `{project-root}/_gsane/_memory/sidecar/memories.md` |
