...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/_gsane/core/workflows/brainstorming/workflow.md'
...
menu:
  ...
  - trigger: SM or fuzzy match on save-memory
    action: 'Update {project-root}/_gsane/_memory/journal-keeper-sidecar/memories.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/_gsane/core/workflows/party-mode/workflow.md'
...
7. **Sidecar paths:** `{project-root}/_gsane/_memory/{sidecar-folder}/`
