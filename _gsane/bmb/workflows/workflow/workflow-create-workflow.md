...
description: Create a new GSANE workflow with proper structure and best practices
web_bundle: true
...
**[C]onvert existing** - Convert an existing workflow to GSANE compliant format
