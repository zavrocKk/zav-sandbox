# GSANE Workflow Step Template

This template provides the standard structure for all GSANE workflow step files. Copy and modify this template for each new step you create.
...
workflow\*path: '{project-root}/_gsane/[module]/reference/workflows/[workflow-name]' # the folder the workflow.md file is in
