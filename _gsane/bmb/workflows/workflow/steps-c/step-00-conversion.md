...
description: 'Convert existing workflow to GSANE compliant format by reading all instructions and extracting plan'
...
Convert an existing workflow (any format) to GSANE compliant format by fully reading and understanding every instruction, extracting the essence, and creating a plan document.
...
"I can help you convert an existing workflow to GSANE compliant format.
...
{List what's missing for GSANE compliance}
```
