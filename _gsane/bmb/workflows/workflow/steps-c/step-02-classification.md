...
- Typically: `_gsane/custom/src/workflows/{workflow-name}/`
...
- IF A: Execute {project-root}/_gsane/core/workflows/advanced-elicitation/workflow.xml
- IF P: Execute {project-root}/_gsane/core/workflows/party-mode/workflow.md
