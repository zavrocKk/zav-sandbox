...
| Variable | Example |
|----------|---------|
| `{project-root}` | `/Users/user/dev/GSANE-METHOD` <!-- validate-file-refs:ignore --> |
| `{project_name}` | `my-project` |
| `{output_folder}` | `/Users/user/dev/GSANE-METHOD/output` <!-- validate-file-refs:ignore --> |
| `{user_name}` | `Brian` |
...
| External References | `{project-root}/...` | `{project-root}/_gsane/core/workflows/...` |
