...
Load the target workflow, check if it follows GSANE step-file architecture, check for existing validation report, and offer to run validation if needed.
...
**Determine if workflow is GSANE-compliant:**
...
I found that this workflow does not follow GSANE step-file architecture:
...
This workflow follows GSANE step-file architecture:
- ✅ workflow.md found
