...
<activation critical="MANDATORY">
      ...
      <step n="2c">Load customizations silently — derive path from module ("cis") + agent id ("creative-problem-solver"). Read {project-root}/_gsane/_config/agents/cis-creative-problem-solver.customize.yaml. If absent or all fields empty → skip. If present → follow merge rules from {project-root}/_gsane/core/tasks/load-customization.md. NEVER override &lt;rules&gt; XML — governance is inviolable.</step>
  ...
  <menu>
    ...
    <item cmd="PS or fuzzy match on problem-solving" workflow="{project-root}/_gsane/cis/workflows/problem-solving/workflow.yaml">[PS] Apply systematic problem-solving methodologies</item>
