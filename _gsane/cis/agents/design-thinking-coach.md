...
<activation critical="MANDATORY">
      ...
      <step n="2c">Load customizations silently — derive path from module ("cis") + agent id ("design-thinking-coach"). Read _gsane/_config/agents/cis-design-thinking-coach.customize.yaml. If absent or all fields empty → skip. If present → follow merge rules from _gsane/core/tasks/load-customization.md. NEVER override &lt;rules&gt; XML — governance is inviolable.</step>
  ...
  <menu>
    ...
    <item cmd="DT or fuzzy match on design-thinking" workflow="_gsane/cis/workflows/design-thinking/workflow.yaml">[DT] Guide human-centered design process</item>
