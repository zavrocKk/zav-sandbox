...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BS or fuzzy match on brainstorm" workflow="_gsane/core/workflows/brainstorming/workflow.md">[BS] Guide me through Brainstorming any topic</item>
