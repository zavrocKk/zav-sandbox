...
main_config: '{project-root}/_gsane/cis/config.yaml'
...
quick_dev_workflow: '{project-root}/_gsane/cis/workflows/gsane-quick-flow/quick-dev/workflow.md'
...
Read fully and follow: `{project-root}/_gsane/cis/workflows/gsane-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
