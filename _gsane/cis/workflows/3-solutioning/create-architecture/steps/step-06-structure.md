...
- Load `{project-root}/_gsane/cis/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_gsane/cis/workflows/3-solutioning/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
