...
GSANE (Governance System for AI-Native Execution) is a flat-design multi-agent system. The active runtime is the 5-agent Strike Team orchestrated by Langis (Master).
...
- **PRs MUST have a description** — never submit with an empty description
